...
const testimonials = [
  ...
  {
    text: "The support team is exceptional, guiding us through setup...",
    image: "https://randomuser.me/api/portraits/women/3.jpg",
    name: "Saman Malik",
    role: "Customer Support Lead",
  },
  {
    text: "This ERP's seamless integration enhanced our business operations...",
...
const Testimonials = () => {
  return (
    <section className="bg-background mt-5 mb-20 relative">
